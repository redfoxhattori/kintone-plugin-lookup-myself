...
type Props = ContainerProps & {
  ...
  onRelatedChange: ChangeEventHandler<HTMLInputElement>;
...
const Container: VFC<ContainerProps> = ({ condition, index }) => {
  ...
  const onRelatedChange: ChangeEventHandler<HTMLInputElement> = (e) => {
    setConditionProps('related', e.target.value);
  };
  const onTargetChange: ChangeEventHandler<HTMLInputElement> = (e) => {
    setConditionProps('target', e.target.value);
  };
